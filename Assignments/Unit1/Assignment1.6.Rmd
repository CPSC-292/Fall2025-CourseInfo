...
*For the following inputs, list __all__ of the atomic data types that would be appropriate to store data in R AND code an example of each. 'Appropriate' means that it retains the specific information that someone would want to keep, for example: storing the number 7 as a numeric or integer would keep the value of 7, but storing 7 as a character would not. *
